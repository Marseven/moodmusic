    ...
    >
      <button type="submit" aria-label={trans(message('Search'))} className="bg-transparent border-none p-0 m-0 hover:bg-transparent focus:bg-transparent">
        <svg aria-hidden="true" 
          focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-testid="SearchOutlinedIcon" className="svg-icon text-muted flex-shrink-0 icon-md" height="1em" 
